...
def build_llm_model():
    """根据环境变量决定使用 OpenAI、DeepSeek 还是 Qwen 兼容接口。"""
    provider = os.getenv("WEIBO_MODEL_PROVIDER", "openai").lower()
    model_name = os.getenv("WEIBO_MODEL_NAME", "gpt-4o-mini")
    custom_url = os.getenv("WEIBO_COMPATIBLE_API_URL")
